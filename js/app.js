...
document.addEventListener('DOMContentLoaded', () => {
    mostrarAutos(autos); //Muestra todos los autos disponibles
...
function llenarSelect() {
    for (let i = max; i >= min; i--) {
        ...
        year.appendChild(option); //Agrega las opciones al selct
    }
}
...
function noResultado() {
    ...
    noResultado.textContent = 'No hay resultados con estos parametros';
